...
- Política de arquivo: `markdown + json de report/manifest <=2MB`.
- Arquivos varridos: **374**
- Experimentos/identificadores catalogados: **27**
- Artefatos referenciados: **729** (existentes: **725**; hasheados: **600**)

## Experimentos identificados (amostra)
- `EXP_001`: fontes=1, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_001_CTRL_RL_MODE_LAYER_V1`: fontes=13, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_002A`: fontes=2, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_002A_MASTER_REGIME_V4`: fontes=17, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_002A_MASTER_REGIME_V4C`: fontes=31, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_002B`: fontes=1, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_002B_MASTER_REGIME_SUPERVISED_PRICE_THEORY_V1`: fontes=22, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_003A`: fontes=1, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_003A_MASTER_REGIME_V6_4STATE`: fontes=30, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_003B`: fontes=1, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_003B_MASTER_REGIME_V7_5STATE`: fontes=23, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_003C`: fontes=2, métricas=0, resultados=0, CEP=0, forense=0
- `EXP_003C_MASTER_BUY_SSOT_V8`: fontes=25, métricas=0, resultados=0, CEP=0, forense=0
...
- `M0`: fontes=120, métricas=24, resultados=24, CEP=1, forense=6
- `M1`: fontes=120, métricas=26, resultados=28, CEP=0, forense=7
- `M3`: fontes=120, métricas=14, resultados=7, CEP=1, forense=6
- `M4`: fontes=120, métricas=1, resultados=0, CEP=108, forense=0
- `M5`: fontes=103, métricas=1, resultados=0, CEP=0, forense=0
- `M6`: fontes=120, métricas=1, resultados=0, CEP=2, forense=1
- `W1`: fontes=56, métricas=2, resultados=0, CEP=0, forense=3
- `W2`: fontes=53, métricas=3, resultados=3, CEP=0, forense=3
...
## Uso de CEP/SPC
- Menções a CEP/SPC, Xbarra/Xbar, I-MR, Western/Nelson e controle estatístico foram mapeadas por experimento e referências gerais.
